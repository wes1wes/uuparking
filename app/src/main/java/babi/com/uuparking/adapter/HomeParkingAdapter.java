...
public class HomeParkingAdapter extends BaseAdapter implements View.OnClickListener {
    Context context;
    List<NearbyCarports> nearbyCarportsList;
    NearbyCarports nearbyCarport;

    public HomeParkingAdapter(Context context, List<NearbyCarports> nearbyCarportsList, Callback callback) {
        super();
    ...
    public Object getItem(int position) {
        return nearbyCarportsList.get(position);
    }
