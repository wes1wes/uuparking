...
//        System.out.println("该身份证所属地址代码为：" + this.cardNumber.substring(0, 6));
    ...
    private static String contertToNewCardNumber(String oldCardNumber) {
        ...
        buf.append(IdentityCard.calculateVerifyCode(buf));
        return buf.toString();
    }
    ...
    public static void main(String[] args) {
        IdentityCard ic = new IdentityCard("500221198501274913");
        ic.getCardNumber();
        ic.getAddressCode();
        System.out.println(ic.getBirthDate());
        System.out.println(ic.getBirthDayPart());
        System.out.println(ic.getGenderCode());
        System.out.println("===================");
